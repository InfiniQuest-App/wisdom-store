 ...
 *
 * Calls the Anthropic API (against the user's Pro/Max OAuth) to produce a structured
 ...
 * if no OAuth credential is available — the user's stated preference.
 *
 * Cost is always reported (the user: visibility-by-default, no opt-in dance).
 */
